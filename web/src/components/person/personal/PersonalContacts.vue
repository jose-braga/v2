    ...
    methods: {
        initialize () {
            if (this.$store.state.session.loggedIn) {
                ...
                subUtil.getInfoPopulate(this, 'api/people/' + personID + '/personal-address', false)
                .then( (result) => {
        ...
        submitForm () {
            if (this.$v.$invalid) {
                ...
                if (this.data.personal_addresses.id !== undefined) {
                    requests.push(this.$http.put('api/people/' + personID + '/personal-address/' + this.data.personal_addresses.id,
                        {
                            data: this.data
                        },
                        {
                    ...
                    requests.push(this.$http.post('api/people/' + personID + '/personal-address',
                        {
                            data: this.data
                        },
                        {
                ...
                if (this.data.personal_phones.id !== undefined) {
                    requests.push(this.$http.put('api/people/' + personID + '/personal-phone/' + this.data.personal_phones.id,
                        {
                            data: this.data
                        },
                        {
                    ...
                    requests.push(this.$http.post('api/people/' + personID + '/personal-phone',
                        {
                            data: this.data
                        },
                        {
                ...
                if (this.data.personal_emails.id !== undefined) {
                    requests.push(this.$http.put('api/people/' + personID + '/personal-email/' + this.data.personal_emails.id,
                        {
                            data: this.data
                        },
                        {
                    ...
                    requests.push(this.$http.post('api/people/' + personID + '/personal-email',
                        {
                            data: this.data
                        },
                        {
