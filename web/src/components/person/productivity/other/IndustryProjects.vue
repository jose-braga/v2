...
export default {
    ...
    methods: {
        initialize () {
            ...
            let urlSubmit = 'api/people/' + personID  + '/industry-projects';
            ...
            .then( (result) => {
                ...
                if (this.dialog && this.editedIndex > -1) {
                    ...
                    //this.editedItem = this.data.projects[this.editedIndex];
                }
            });
        ...
        searchProjects (search) {
            ...
            if (search.length > minimumLength) {
                ...
                let personID = this.$store.state.session.personID;
                let urlSubmit = 'api/people/' + personID + '/all-industry-projects'
                                + '?';
