...
>
    ...
    <v-card-text>Reviewer input is necessary for <b>Interview</b>,
        <b>Letters of Reference</b>, <b>Motivation Letter</b> and to check if
        Master thesis has a scientific basis.
        <br>
                        ...
                        <v-expansion-panel-content>
                                    ...
                                    <v-expansion-panel-content>
                                        ...
                                        <div v-if="Object.keys(criteria2.children).length === 0">
                                            ...
                                            <div v-if="criteria2.criteria_name === 'Scientific activity'">
                                                ...
                                                <ol>
                                                    <li v-for="(datum, i) in data.application.mobility"
                                                        :key="key1 + '-' + key2 + '-' + i"
                                                    >
                                                        <span class="highlight">{{datum.title}}</span>
                            ...
                            <div v-if="Object.keys(criteria1.children).length === 0">
                                <div v-if="criteria1.criteria_name === 'Academic Curriculum'">
                                    ...
                                    <div v-if="data.application.erasmus_experience">The candidate participated in <b>Erasmus Programme</b></div>
                                </div>
