    ...
    >
        ...
        <v-container>
            ...
            <v-row>
                ...
                <v-col cols="6" sm="2">
                    <v-text-field v-model="$v.itemDetails.item_details.amount_euro.$model"
                        :error="$v.itemDetails.item_details.amount_euro.$error"
                        label="Amount (€)"
                    ></v-text-field>
                </v-col>
            </v-row>
                ...
                let urlUpdate = [
                    {
                        url: 'api' + this.endpoint
                            + '/members'
                            + '/' + personID
                            + '/prizes/' + this.itemDetails.prize_id,
