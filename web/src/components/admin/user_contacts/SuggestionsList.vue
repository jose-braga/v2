...
<v-card>
    <v-card-title primary-title>
        <div>
            <h3 class="headline">Suggestions list</h3>
        </div>
    </v-card-title>
    <v-container>
        <v-data-table
    ...
    data() {
        return {
            ...
            headers: [
                ...
                { text: 'Received', value:'date_sent' },
                { text: 'Implemented', value:'date_solved' },
    ...
    methods: {
        initialize () {
            ...
            if (this.$store.state.session.loggedIn) {
                ...
                subUtil.getInfoPopulate(this, 'api/admins/' + personID + '/suggestions', true)
                .then( (result) => {
