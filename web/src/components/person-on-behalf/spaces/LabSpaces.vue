...
export default {
    ...
    mounted() {
        this.initialize();
        this.getSpaces();
        this.$root.$on('otherPersonUpdateLabSpaceTable',
            () => {
                this.initialize();
            }
        );
    ...
    methods: {
        initialize () {
            let urlSubmit = 'api/people/' + this.otherPersonId + '/labs/' + this.lab + '/spaces';
            ...
            urlSubmit = 'api/people/' + this.otherPersonId + '/labs/' + this.lab;
            subUtil.getInfoPopulate(this, urlSubmit, true)
            .then((result) => {
        ...
        submitForm () {
            if (this.$store.state.session.loggedIn) {
                ...
                let urlCreate = [];
                urlCreate.push({
                    url: 'api/people/' + this.otherPersonId + '/labs/' + this.lab
                        + '/spaces',
