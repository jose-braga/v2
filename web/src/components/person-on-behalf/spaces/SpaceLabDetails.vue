...
export default {
    ...
    methods: {
        initialize () {
            ...
            let urlSubmit = 'api/people/' + this.otherPersonId + '/labs/' + this.labId + '/spaces/' + this.spaceId;
        ...
        submitForm () {
            ...
            for (let ind in this.spaceDetails.labs) {
                ...
                urlUpdateLab.push({
                    url: 'api/people/' + this.otherPersonId + '/labs/' + this.labId
                        + '/spaces/' + this.spaceId,
                    body: datum,
                });
            }
            ...
            .then(() => {
                ...
                this.$root.$emit('otherPersonUpdateLabSpaceTable')
                //this.initialize();
            })
            .catch((error) => {
                this.progress = false;
