...
<v-card>
    ...
    >
        <v-card-title>
            <span> Edit data for dataset
                    <b>{{ itemDetails.item_details.database_name }}</b>
            </span>
        </v-card-title>
        <v-card-text>
        </v-card-text>
        <v-container>
            <v-form ref="form"
                ...
                <v-row>
                    ...
                    <v-col cols="12" sm="3">
                        <v-select v-model="itemDetails.item_details.data_set_type_id"
                            :items="datasetTypes"
                            item-value="id"
                            item-text="name"
                            label="Dataset type">
                ...
                let urlUpdate = [
                    {
                        url: 'api/people/' + personID
                            + '/datasets/' + this.itemDetails.data_set_id,
