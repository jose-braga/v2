...
<v-card flat>
    ...
    <v-container>
        ...
        <v-row>
            <p class="mt-2"> To avoid duplicates, please search below to find if prize isn't
...
export default {
    ...
    methods: {
        initialize () {
            ...
            let urlSubmit = 'api/people/' + personID  + '/prizes';
        ...
        searchItems (search) {
            ...
            if (search.length > minimumLength) {
                ...
                let personID = this.otherPersonId;
                let urlSubmit = 'api/people/' + personID + '/all-prizes'
                                + '?';
