...
//const unitCityDocs = require('../controllers/docs/unitCityDocs');

router.get('/:unitID/documents', cors(corsOptions), unitDocs.getDocs);
...
//router.get('/:unitID/cities/:cityID/documents', cors(corsOptions), unitCityDocs.getDocs);
