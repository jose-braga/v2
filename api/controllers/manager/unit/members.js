...
var actionGetCurrentMembersList = function (options) {
    ...
    if (req.query.q !== undefined) {
        ...
        qArray.push(qraw);
        likeNameExpression = likeNameExpression + ' OR ';
        likeNameExpression = likeNameExpression + 'BINARY people.id = ?';
        qArray.push(qraw);
        likeNameExpression = likeNameExpression + ') ';
    }
    ...
    places = [unitID].concat(qArray).concat([lab, lab, labID, group, group, today, today, today, today])
...
var actionGetPastMembersList = function (options) {
    ...
    querySQL = querySQL
        ...
        + ')';
    places = [unitID].concat(qArray).concat([lab, lab, labID, group, group, today, today])
